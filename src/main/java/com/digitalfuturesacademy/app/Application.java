...
public class Application {
    public static void main(String[] args) {
        ...
        Contact contact1 = new Contact("Joseph", "Mitchell", "01234567890",
                                       "joseph@example.com", details1);

        LinkedHashMap<String, String> details2 = new LinkedHashMap<>();
        details2.put("Company", "Digital Futures");
        Contact contact2 = new Contact("Joseph", "Lastname", "09876543210",
                                       "joseph@gmail.com", details2);
        ...
        Contact contact3 = new Contact("Unknown", "Entity", "00000000000",
                                       "who@where.how", details3);
